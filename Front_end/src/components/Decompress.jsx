...
import { getFiles, uploadFile } from "../services/FileUploadService_decompress";
...
const Decompress  = () => {
  ...
  const [selectedFiles, setSelectedFiles] = useState(undefined);
    ...
    const download = (e) => {
      FileDownload(responseText , fileName  + "-decompress.txt");
    }
    ...
    return (
      <div className="App">
        ...
        <ParticlesContainer />
        <div className="header">Decompress</div>
