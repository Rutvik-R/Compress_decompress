...
export default function WriteYourOwn() {
    ...
    return (
        <div className="min-w-fit w-[90%] min-h-fit ml-[5%] h-[70%] flex mt-[2%]">
            {done_file_name ? <div className="absolute p-2 bottom-[20px]  h-[100px] min-w-[10%] w-fit opacity-70 hover:opacity-100 right-[5%] bg-green-100  rounded-lg text-center boxShadow font-semibold animate-bounce z-50" >
                {done_file_name} is successfully compressed
                <Button className='bg-orange-200 mt-5 ml-9 w-[200px] h-[40px] border-2 rounded-md hover:bg-orange-400 hover:boxShadow' onClick={() => onDownload()}>download</Button>
