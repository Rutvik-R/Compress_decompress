...
import FileSelect from '../components/decompress/fileSelect';
import WriteYourOwn from '../components/decompress/writeYourOwn';
    ...
    return (
        <div className="h-fit min-h-screen w-fit min-w-full gradientCompress bg-repeat">
            ...
            <div className="w-full  h-fit">
                <div className="w-full text-center text-5xl font-semibold text-white">Decompress</div>
                <Button bordered onPress={() => { setChoice(!choice) }} disabled={true} className='w-52 gradientCompressButton h-10 ml-10' >{choice ? 'Write your own' : 'Upload text file'}</Button>
            </div>
